...
const loadTable = (attributes, key, table, view, transform, filter, limit) => {
...
const loadUiTemplates = (attributes) => {
   return loadTable(attributes, 'uiTemplates', 'UI Strings', 'Grid view', (record) => {
