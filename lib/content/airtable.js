class AirtableContent {
    ...
    constructor(config) {
        ...
        this.constructor.Airtable().configure({apiKey: config.airtableApiKey});
        this.base = Airtable.base(config.airtableBaseId);
    ...
    loadUiTemplates(attributes, forceReload) {
        return this.loadTable(attributes, forceReload, 'uiTemplates', this.uiTable, this.uiView, (record) => {
            ...
            return {id: record.get('Id'), data: record.get('Voice Content')};
        })
    }
