...
module.exports = class Analytics {
  ...
  async trackEvent (caller, params, userProperties = null) {
    const out = []
    try {
      ...
      let sendParams = {
        _userId: this.shortenId(caller.userId()),
      ...
      for (const receiver of this.receivers) {
        out.push(await receiver.trackEvent(sendParams, userProperties, caller))
      }
