...
class BaseHandler extends Base {
  ...
  templateResponse (id, tempData, endSession = true, repromptId = null) {
    const self = this
    this.handleFollowup(id, endSession)
  ...
  */
  ...
  loadState () {
    ...
    this.setSessionState({
      'last-intent-name': this.getState('current-intent-name'),
      'current-intent-name': this.requestedIntentName(),
      'last-request-type': this.getState('current-request-type'),
      // temp way to get type
      'current-request-type': this.handlerInput.requestEnvelope.request.type
    })
